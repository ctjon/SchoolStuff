...
+----------------------------------------------------------------------------*/
{
    ...
    aprintf("\n");
    aprintf("\n\nscheduler - press a key to continue\n");
    getchar();
    dump_sem_list();
    ready_q = destroy_list(ready_q);
    block_q = destroy_list(block_q);
    sem_shutdown();
    aprintf("\n\nscheduler - ipc_stat follows - press a key to continue\n");
    getchar();
    ipc_stat();
    aprintf("\n\nscheduler - fs_shutdown follows - press a key to continue\n");
    getchar();
    fs_shutdown();		/* clean up file system */
...
+----------------------------------------------------------------------------*/
{
    ...
    aprintf("OS4U Process Scheduler Subsystem Initialization Complete\n");
}
...
void sig_abort(void)
{
    ...
    old_priority = enter_crit();
    aprintf("\ninterrupt signal caught - sig_aborting\n");
    aprintf("dumping system status - press a key to continue\n");
    getchar();
    aprintf("current process scheduling subsystem status\n");
    aprintf("--------------------------------------------------------\n");
    aprintf("%10s %10s %10s %10s\n",
    ...
    block_q = destroy_list(block_q);
    sem_shutdown();
    aprintf("\n\nsig_abort - ipc_stat follows - press a key to continue\n");
    getchar();
    ipc_stat();
    aprintf("\n\nsig_abort - fs_shutdown follows - press a key to continue\n");
    getchar();
    fs_shutdown();		/* clean up file system */
    ipc_shutdown();		/* clean up ipc stuff    */
    unmmalloc();		/* return memory to unix */
    pod_exit(2);
}
...
void segmentation(void)
{
    ...
    old_priority = enter_crit();
    aprintf("\nSEGMENTATION VIOLATION SIGNAL CAUGHT - ABORTING\n");
    aprintf("dumping system status - press a key to continue\n");
    getchar();
    aprintf("current process scheduling subsystem status\n");
    aprintf("--------------------------------------------------------\n");
    ...
    block_q = destroy_list(block_q);
    sem_shutdown();
    aprintf("\n\nsegmentation - ipc_stat follows - press a key to continue\n");
    getchar();
    ipc_stat();
    aprintf("\n\nsegmentation - fs_shutdown follows - press a key to continue\n");
    getchar();
    fs_shutdown();		/* clean up file system */
    ipc_shutdown();		/* clean up ipc stuff    */
    unmmalloc();		/* return memory to unix */
