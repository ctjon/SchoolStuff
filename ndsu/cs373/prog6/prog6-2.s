...
FLAGSET	TAS	SFLAG
	RTE
*
TR14INT	CMP.B	#243,D7		COMPARE 243
	BNE	DOJUMP		!= DO THE JUMP
	ORI	#$700,SR	TURN OFF INTERUTPS
	TAS	FLAG		SET THE FLAG
	PEA	TR14RET		PUSH THE RETURN VALUE
	MOVE.W	SR,-(SP)	PUSH THE STATUS REGISTER
DOJUMP	JMP	TR14LOC
TR14RET	CLR.B	FLAG		WE'RE DONE
	CMP.B	#0,SFLAG	CHECK IF WE SHOULD CALL GOSUPER
	BEQ	NOFLAG		YES JUMP
	CLR.B 	SFLAG		CLEAR IT
	JMP	GOSUPER
NOFLAG	RTE			RETURN
*	
*
